The goal of this project was to add script in such a way as to display the current date at the top of the page, programatically add a certain number of hour blocks, 
